...
class ModuleNotLoadedError(Exception):
    """Raised when the manager is asked for an instance
       of a plugin that has not been loaded
    """
    pass


class ModuleAlreadyLoadedError(Exception):
    """Raised when the system tries to load a plugin
       that is already loaded and doesn't support multiple instances
    """
    pass
